...
public class ProductRepositoryTest {
    ...
    void testUpdateProduct(){
        ...
        Product selectedProduct = productRepository.update(changeProduct);
    ...
    void testDeleteProduct(){
        ...
        Product deleteProduk = productRepository.delete(numberId);
    ...
    void testDeleteProductNotFound(){
        ...
        Product deleteProduk = productRepository.delete(randomId);
